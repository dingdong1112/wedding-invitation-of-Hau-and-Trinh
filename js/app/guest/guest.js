 ...
 */
    ...
    <div class="swiper-slide d-flex justify-content-center align-items-center">
        <img src="${url}" class="img-fluid" style="max-height: calc(100vh - 120px); object-fit: contain;">
        <!-- Tăng max-height của ảnh chính lên, trừ đi chiều cao của thanh thumbnail (100px) + padding -->
    </div>`;
        ...
        // 1. Mở Modal TRƯỚC khi khởi tạo Swiper
        bs.modal('detailModal').show();

        // 2. Sử dụng setTimeout để đảm bảo Modal đã mở xong transition (fix lỗi)
        setTimeout(() => {

            // --- 3. Khởi tạo Swiper Thumbnail ---
            const swiperThumbs = new Swiper("#thumb-swiper", {
                spaceBetween: 10,
                slidesPerView: 4, // <-- HIỂN THỊ CỐ ĐỊNH 4 THUMBNAIL CÙNG LÚC
                freeMode: true,
        ...
        const swiperMain = new Swiper("#main-swiper", {
            ...
            // Fix lỗi cube effect không hiển thị
            cubeEffect: {
                shadow: false, // Tắt Shadow nếu lỗi vẫn xảy ra
                slideShadows: true,
                shadowOffset: 20,
                shadowScale: 0.94,
            },
    ...
    }, 300); // Tăng độ trễ lên 300ms để Modal hiển thị ổn định
};
